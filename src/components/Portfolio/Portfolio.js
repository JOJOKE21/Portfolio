...
export default function Portfolio() {
  return <div className='page2 padding' id="portfolio">
    ...
    <div className='tex3'>
       ...
       <p className='cent'>This is the project where we had to make a game in the course of little over a week. My game concept is to survive as long as possible fighting against
       a wave of cheese. Get hit three times and you lose. Try your best to get a high score.
       </p> 
